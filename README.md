...
- **HEIC変換**: libheif-jsでJPEGへ変換
- **動画・音声変換**: @ffmpeg/ffmpegでMP4またはMP3へ変換
- **一括ダウンロード**: JSZipでZIPファイルを生成
- **エラー処理**: WASMライブラリの初期化・変換に失敗した場合は、ダミーファイルを生成せずエラーとして表示
- **推奨環境**: WASMライブラリが正常に動作するChrome / Edge
